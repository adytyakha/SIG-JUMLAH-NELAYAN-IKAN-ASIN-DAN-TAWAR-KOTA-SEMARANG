...
var style_kotasemarang_0 = function(feature, resolution){
    ...
    var value = feature.get("jumlahtota");
    var labelText = "";
    size = 0;
    ...
    if (value > 0.000000 && value <= 27.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 27.000000 && value <= 56.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 56.000000 && value <= 75.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 75.000000 && value <= 151.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value > 151.000000 && value <= 1247.000000) {
            style = [ new ol.style.Style({
